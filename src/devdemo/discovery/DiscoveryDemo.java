...
import devdemo.DemoDialog;
import devdemo.NumericTextField;
...
public class DiscoveryDemo extends DemoDialog {
    ...
    private static final String USB_DIRECT_SEARCH = "Find USB Printers";
    ...
    public DiscoveryDemo(JFrame owner) {
        ...
        discoveryMethodCombo = new JComboBox(new String[] { LOCAL_BROADCAST, DIRECTED_BROADCAST, MULTICAST_BROADCAST, SUBNET_SEARCH, USB_DRIVER_SEARCH, USB_DIRECT_SEARCH, PRINTERS_NEAR_ME });
        ...
        JPanel usbDirectCard = createUsbDirectCard();
        ...
        cardPanel.add(usbDirectCard, USB_DIRECT_SEARCH);
